...
def translate_priest(speech: str, role: str | None) -> tuple[str, str]:
    ...
    patterns: list[tuple[re.Pattern[str], str, str]] = [
        ...
        (re.compile(r'Have mercy on us, O God, according to Thy great mercy, we pray Thee', re.I),
         'ΙΕΡΕΥΣ: Ἐλέησον ἡμᾶς, ὁ Θεός, κατὰ τὸ πολὺ ἔλεός σου, δεόμεθά σου, εἰσάκουσον καὶ ἐλέησον.',
         'Священник: Помилуй нас, Боже, по велицей Твоей милости, молим Тя, услыши и помилуй.'),
        (re.compile(r'O Lord almighty, the God of our Fathers, we pray Thee, hear us and have mercy', re.I),
         'ΙΕΡΕΥΣ: Κύριε Παντοκράτορ, ὁ Θεὸς τῶν πατέρων ἡμῶν, δεόμεθά σου, εἰσάκουσον καὶ ἐλέησον.',
         'Священник: Господи Вседержителю, Боже отец наших, молим Тя, услыши и помилуй.'),
        (re.compile(r'Again we pray for the blessed and ever-memorable founders of this holy house', re.I),
         'ΙΕΡΕΥΣ: Πάλιν δεηθῶμεν ὑπὲρ τῶν μακαρίων καὶ ἀειμνήστων κτιστῶν τοῦ ἱεροῦ οἴκου τούτου, καὶ ὑπὲρ πάντων τῶν πατέρων καὶ ἀδελφῶν ἡμῶν, τῶν ὀρθοδόξων προαναπαυσαμένων τῆςδε καὶ ἐν παντὶ τόπῳ κεκοιμημένων ἐν Χριστῷ.',
         'Священник: Паки помолимся о блаженных и приснопамятных создателях сего святаго дома, и о всех отцех и братиях наших, православных прежде почивших, зде и во всем мире во Христе уснувших.'),
