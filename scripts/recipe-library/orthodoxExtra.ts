...
R({
  ...
  R({
    ...
    ingredients: lines(
      [
        '2 cups (400 g) whole wheat berries',
        '½ cup (120 ml) honey',
        '½ cup (70 g) walnuts, finely chopped',
        '½ cup (80 g) raisins',
        '1 tsp ground cinnamon',
        'Pinch of salt',
        'Decor: powdered sugar, pomegranate seeds, slivered almonds',
      ],
      [
        '400 г цельной пшеницы',
        '120 мл мёда',
        '70 г грецких орехов, мелко нарубленных',
        '80 г изюма',
        '1 ч.л. корицы',
        'щепотка соли',
        'Украшение: сахарная пудра, зёрна граната, миндаль',
      ],
      [
        '400 γρ. σιτάρι ολικής',
        '120 ml μέλι',
        '70 γρ. καρύδια ψιλοκομμένα',
        '80 γρ. σταφίδες',
        '1 κ.γ. κανέλα',
        'μια πρέζα αλάτι',
        'Διακόσμηση: ζάχαρη άχνη, ρόδι, αμύγδαλα',
      ],
    ),
    steps: lines(
      [
        'Rinse wheat, cover with plenty of water, and soak overnight (or boil directly 45–60 minutes until tender).',
        'Drain well. Stir honey, cinnamon, and salt into the warm wheat.',
        'Fold in walnuts and raisins. Press into a shallow bowl or tray, smoothing the top.',
        'Decorate with powdered sugar, pomegranate seeds, and slivered almonds, often in a cross pattern.',
      ],
      [
        'Промойте пшеницу, залейте водой и замочите на ночь (или варите 45–60 минут до мягкости).',
        'Слейте воду. Добавьте мёд, корицу и соль в тёплую пшеницу.',
        'Вмешайте орехи и изюм. Уложите в блюдо, разровняв верх.',
        'Украсьте сахарной пудрой, зёрнами граната и миндалём, часто — крестом.',
      ],
      [
    ...
    tips: lines(
      ['Ask your priest to bless the kolyva before serving at a memorial.', 'Can be made a day ahead; keep refrigerated until use.'],
      ['Освятите коливо в храме перед поминальной трапезой.', 'Можно приготовить заранее и хранить в холодильнике.'],
      ['Μπορεί να ευλογηθεί στην εκκλησία πριν το μνημόσυνο.', 'Ετοιμάζεται από την προηγούμενη μέρα.'],
    ),
  }),
];
