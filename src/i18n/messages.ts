...
const en = {
  ...
  jesusPrayer: {
    ...
    ofTarget: 'of {target}',
    reset: 'Start again',
    tip: 'Many keep a prayer rope (chotki) at home, in the car, or before sleep. Ask your priest or spiritual father for guidance.',
  },
  liturgy: {
    chrysostom: {
      intro:
...
const ru = {
  ...
  jesusPrayer: {
    ...
    ofTarget: 'из {target}',
    reset: 'Начать снова',
    tip: 'Многие носят чётки дома, в дороге или перед сном. Спросите священника или духовника о практике.',
  },
  liturgy: {
    chrysostom: {
      intro:
