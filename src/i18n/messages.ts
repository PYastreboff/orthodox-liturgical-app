...
const en = {
  ...
  settings: {
    ...
    personalDays: 'Parish Feast Days & Namedays',
    personalDaysHint: 'Add your own parish feast and nameday dates (Gregorian or Julian).',
    personalDaysRowHint: 'Shows on Calendar; optional eve reminders.',
...
const ru = {
  ...
  settings: {
    ...
    personalDays: 'Приходские праздники и именины',
    personalDaysHint: 'Добавьте свои даты приходского праздника и именин (григорианский или юлианский).',
    personalDaysRowHint: 'Показывается в Календаре; можно включить напоминание накануне.',
