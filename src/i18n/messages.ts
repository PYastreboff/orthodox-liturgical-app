...
const en = {
  ...
  tabs: {
    ...
    browserTitlePrayers: 'OrthoDaily - Prayers',
    browserTitleLiturgy: 'OrthoDaily - Worship',
    browserTitleWorship: 'OrthoDaily - Worship',
    browserTitleSettings: 'OrthoDaily - Settings',
    prayersSubtitle: 'Morning, evening, Communion, and daily rule.',
    liturgySubtitle: 'Follow along at Vespers and the Divine Liturgy.',
    worshipTitle: 'Worship',
    worshipSubtitle: 'Follow along at Vespers and the Divine Liturgy.',
  ...
  settings: {
    ...
    personalDaysRowHint: 'On Today and Calendar; optional eve reminders.',
    ...
    notificationsWebOnly: 'Alerts only run in the phone app.',
    ...
    privacyPolicyHint: 'How OrthoDaily handles your data.',
    supportLink: 'Support & Feedback',
    supportHint: 'Report a problem or question on GitHub.',
    ...
    colorsLegendLinkHint: 'Fast pills, calendar cells, icons, Typikon marks.',
  ...
  today: {
    ...
    vestmentsPageTitle: 'Vestments for {role}',
    churchDressPageTitle: 'Church Clothing for {role}',
    ...
    sectionBible: 'The Bible',
    sectionFeasts: 'Feasts',
    sectionSaints: 'Saints',
    sectionCommemorations: 'Feasts & Saints',
    tileDate: 'Today',
    ...
    tileFeasts: 'Feasts',
    tileSaints: 'Saints',
    tileCommemorations: 'Feasts & Saints',
    tileServices: 'Services',
    tileVestments: 'Vestments',
    tileChurchDress: 'Church Clothing',
    tileChoirGuide: 'Choir Guide',
    tileAltarRoles: 'Server Guide',
    tileReaderGuide: 'Reader Guide',
    tileDeaconGuide: 'Deacon Guide',
    tilePriestGuide: 'Priest Guide',
    groupWorship: 'Prayer & Liturgy',
    groupScripture: 'Scripture',
    groupTheDay: 'The Day',
    ...
    loadingCommemorations: 'Loading feasts and saints…',
  ...
  services: {
    ...
    livestreams: {
      ...
      upcomingA11y: 'Upcoming live stream from {name}',
      ...
      channels: {
        ...
        strathfieldCathedral: 'Sts Peter and Paul Cathedral, Strathfield',
        pokrovMelbourne: 'Pokrov (Protection) Monastery, Melbourne',
        stNicholasBrisbane: 'St Nicholas Orthodox Church, Brisbane',
        VladimirIconOfTheMotherOfGod:
          'Church of the Vladimir Icon of the Mother of God, Rocklea',
      },
    },
  },
  altarRoles: {
  ...
  prayers: {
    ...
    ropeLinkTitle: 'Prayer Rope',
    ropeLinkHint: 'Count prayers on a spiritual rope',
    morning: {
  ...
  liturgy: {
    ...
    vespers: {
      ...
      offline: 'Vespers text could not be loaded. Check your connection and try again.',
      opening: { title: 'Opening prayers' },
      psalm_103: { title: 'Psalm 103 (Bless the Lord)' },
      great_litany: { title: 'Great Litany' },
      lord_i_have_cried: { title: 'Lord, I have cried' },
      phos_hilaron: { title: 'O Joyful Light' },
      aposticha: { title: 'Aposticha' },
      supplication: { title: 'Supplication & Trisagion' },
...
const ru = {
  ...
  tabs: {
    ...
    calendar: 'Календарь',
    prayers: 'Молитвы',
    liturgy: 'Богослужение',
    settings: 'Настройки',
    calendarHeader: 'Календарь',
    browserTitleCalendar: 'OrthoDaily - Календарь',
    browserTitlePrayers: 'OrthoDaily - Молитвы',
    browserTitleLiturgy: 'OrthoDaily - Богослужение',
    browserTitleWorship: 'OrthoDaily - Богослужение',
    browserTitleSettings: 'OrthoDaily - Настройки',
    prayersSubtitle: 'Утренние, вечерние, причастие и правило.',
    liturgySubtitle: 'Вечерня и Божественная литургия — для следования в храме.',
    worshipTitle: 'Богослужение',
    worshipSubtitle: 'Вечерня и Божественная литургия — для следования в храме.',
    a11yToday: 'OrthoDaily — главная',
    a11yCalendar: 'Литургический календарь',
    a11yPrayers: 'Молитвы',
    a11yLiturgy: 'Богослужение',
  ...
  settings: {
    ...
    notificationsRowHint: 'Только в приложении (iOS и Android).',
    notificationsMobileOnly:
    ...
    personalDaysRowHint: 'На «Сегодня» и в Календаре; напоминание накануне.',
    ...
    notificationsWebOnly: 'Уведомления работают только в приложении.',
    ...
    privacyPolicyHint: 'Как OrthoDaily обрабатывает ваши данные.',
    supportLink: 'Поддержка и отзывы',
    supportHint: 'Сообщить о проблеме или вопросе на GitHub.',
    ...
    colorsLegendLinkHint: 'Метки поста, ячейки календаря, значки, типикон.',
  ...
  today: {
    ...
    vestmentsPageTitle: 'Облачения для {role}',
    churchDressPageTitle: 'Церковная одежда для {role}',
    sectionServices: 'Службы',
    ...
    sectionReadings: 'Чтения',
    sectionBible: 'Писание',
    sectionFeasts: 'Праздники',
    sectionSaints: 'Святые',
    sectionCommemorations: 'Праздники и святые',
    tileDate: 'Сегодня',
    ...
    tileSaints: 'Святые',
    tileCommemorations: 'Праздники и святые',
    tileServices: 'Службы',
    tileVestments: 'Облачения',
    tileChurchDress: 'Одежда',
    tileChoirGuide: 'Памятка певчего',
    tileAltarRoles: 'Памятка алтарника',
    tileReaderGuide: 'Памятка чтеца',
    tileDeaconGuide: 'Памятка диакона',
    tilePriestGuide: 'Памятка священника',
    groupWorship: 'Молитва и литургия',
    groupScripture: 'Писание',
    groupTheDay: 'День',
    ...
    loadingCommemorations: 'Загрузка праздников и святых…',
  ...
  services: {
    ...
    livestreams: {
      ...
      upcomingA11y: 'Предстоящая трансляция: {name}',
      ...
      channels: {
        ...
        strathfieldCathedral: 'Собор первовер. Петра и Павла, Стратфилд',
        pokrovMelbourne: 'Покровский монастырь, Мельбурн',
        stNicholasBrisbane: 'Церковь св. Николая, Брисбен',
        VladimirIconOfTheMotherOfGod:
          'Храм Владимирской иконы Божией Матери, Рокли',
      },
    },
  },
  altarRoles: {
  ...
  prayers: {
    ...
    ropeLinkTitle: 'Чётки',
    ropeLinkHint: 'Считать молитвы на чётках',
    morning: {
  ...
  jesusPrayer: {
    ...
    tapButton: 'Нажмите, чтобы считать',
    tapHint: '{current} из {target}',
    progressA11y: '{current} из {target} молитв',
    complete: 'Чётки завершены — слава Богу',
    countLabel: 'Произнесено',
    ofTarget: 'из {target}',
    reset: 'Начать снова',
    undo: 'Отменить',
    showRope: 'Показать чётки',
    hideRope: 'Скрыть чётки',
  ...
  liturgy: {
    ...
    vespers: {
      ...
      offline: 'Не удалось загрузить текст вечерни. Проверьте соединение и повторите.',
      opening: { title: 'Начальные молитвы' },
      psalm_103: { title: 'Псалом 103 (Благослови, душе моя)' },
      great_litany: { title: 'Великая ектения' },
      lord_i_have_cried: { title: 'Господи, воззвах' },
      phos_hilaron: { title: 'Свете тихий' },
      aposticha: { title: 'Апостихи' },
      supplication: { title: 'Просительная ектения и Трисвятое' },
