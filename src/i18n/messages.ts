...
const en = {
  ...
  settings: {
    ...
    legendPillDesc: {
      ...
      dairy:
        'Tan — meat fast: fast only from meat.',
  ...
  calendar: {
    ...
    legendIconsHint:
      'Fish allowed, wine allowed, oil allowed, meat fast, or no eating (total fast).',
    searchTitle: 'Search',
...
const ru = {
  ...
  settings: {
    ...
    legendPillDesc: {
      ...
      dairy:
        'Бежевый — мясной пост: пост только от мяса.',
