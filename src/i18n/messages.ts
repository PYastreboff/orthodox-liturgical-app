...
const en = {
  ...
  settings: {
    ...
    servingRoleHint:
      'Controls vestments and church clothing on Today — layperson, altar server, reader, deacon, priest, or bishop.',
  ...
  calendar: {
    ...
    legendIconsTitle: 'Symbols on fasting days',
    legendIconsHint:
...
const ru = {
  ...
  settings: {
    ...
    servingRoleHint:
      'Определяет облачения и церковную одежду на экране «Сегодня» — мирянин, алтарник, чтец, диакон, священник или епископ.',
  ...
  calendar: {
    ...
    legendIconsTitle: 'Символы в постные дни',
    legendIconsHint:
