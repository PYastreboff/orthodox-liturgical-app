...
const en = {
  ...
  tabs: {
    ...
    browserTitleLiturgy: 'OrthoDaily - Liturgy',
    browserTitleSettings: 'OrthoDaily - Settings',
    prayersSubtitle: 'Morning, evening, Communion, and daily rule.',
    liturgySubtitle: 'Divine Liturgy of St John Chrysostom — follow along at church.',
